function [HAMILTONIAN,NUMERO] = FERMI_HUBBARD_ANDERSON_FUNCTION(C_d_do,C_do,N_do,C_d_up,C_up,N_up,P,A_id,P_m,J,U,dim,N,Np)
...
for i=(1:Np)
    ...
    Ham=Ham-J*(kron(C_d_do*P,kron(ID1,kron(C_do,ID2)))... %dimension= dim_site^{1+i-1+1+N-i-1}=dim_site^{N}
